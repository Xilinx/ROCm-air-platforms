...
int main(int argc, char *argv[]) {
  ...
  // Creating a queue
  hsa_queue_t *bp_queue;
  queue_create_status = hsa_queue_create(agent, aie_max_queue_size,
                              HSA_QUEUE_TYPE_SINGLE, nullptr, nullptr, 0,
                              0, &bp_queue);
  ...
  // send the data
  //
  uint64_t wr_idx = hsa_queue_add_write_index_relaxed(bp_queue, 1);
  uint64_t packet_id = wr_idx % bp_queue->size;
  hsa_agent_dispatch_packet_t pkt;
  ...
  reinterpret_cast<hsa_agent_dispatch_packet_t *>(bp_queue->base_address)[packet_id] = pkt;

  //
  // read the data
  //

  wr_idx = hsa_queue_add_write_index_relaxed(bp_queue, 1);
  packet_id = wr_idx % bp_queue->size;
  ...
  reinterpret_cast<hsa_agent_dispatch_packet_t *>(bp_queue->base_address)[packet_id] = pkt2;
  ...
  reinterpret_cast<hsa_agent_dispatch_packet_t *>(bp_queue->base_address)[packet_id] = pkt3;
  ...
  reinterpret_cast<hsa_agent_dispatch_packet_t *>(bp_queue->base_address)[packet_id] = pkt4;
  ...
  reinterpret_cast<hsa_agent_dispatch_packet_t *>(bp_queue->base_address)[packet_id] = pkt5;
  ...
  reinterpret_cast<hsa_agent_dispatch_packet_t *>(bp_queue->base_address)[packet_id] = pkt6;
  ...
  reinterpret_cast<hsa_agent_dispatch_packet_t *>(bp_queue->base_address)[packet_id] = pkt7;
  ...
  reinterpret_cast<hsa_agent_dispatch_packet_t *>(bp_queue->base_address)[packet_id] = pkt8;

  // Ringing the doorbell to notify the command processor of the packet
  hsa_signal_store_screlease(bp_queue->doorbell_signal, wr_idx);
